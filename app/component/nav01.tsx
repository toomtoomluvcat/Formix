        ...
        <div className="flex justify-between max-w-[1280px] mx-auto pt-6 px-[30px]">
          ...
          <div>
            <div className="flex text-[13px] gap-[35px] items-center">
                <Link onClick={()=>saveQuestionTolocalstorage?.()}  href="/form01">
              ...
              <Link onClick={()=>saveQuestionTolocalstorage?.()} href={"/form01/preview"}>
              <div className="flex gap-[6px] font-medium items-center">
                <Image
                  src="/Icon-form/3.png"
                  width={20}
              ...
              <Link onClick={()=>saveQuestionTolocalstorage?.()} href="/form01/setting/">
                <div className="flex gap-[6px] font-medium items-center">
                  <Image
                    src="/Icon-form/2.svg"
                    width={20}
